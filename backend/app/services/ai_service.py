...
{{
  ...
  "stats": {{
      "rating": 4.9, // Float 4.7-5.0
      "reviews_count": 1284, // Int 800-5000
      "effectiveness": 95, // Int 85-99 (процент довольных)
      "stat1_label": "Краткое преимущество 1",
      "stat1_value": 96, // Int
      "stat2_label": "Краткое преимущество 2",
      "stat2_value": 93, // Int
      "stat3_label": "Краткое преимущество 3",
      "stat3_value": 95, // Int
      "trust_blocks": [
          {{ "title": "Убедительный заголовок 1", "description": "Краткое описание почему доверяют (макс 5 слов)" }},
          {{ "title": "Убедительный заголовок 2", "description": "Краткое описание почему доверяют (макс 5 слов)" }},
          {{ "title": "Убедительный заголовок 3", "description": "Краткое описание почему доверяют (макс 5 слов)" }},
          {{ "title": "Убедительный заголовок 4", "description": "Краткое описание почему доверяют (макс 5 слов)" }}
      ]
  }}
}}
"""
